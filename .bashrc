...
# source ~/uarm_ws/devel/setup.bash
...
# export GAZEBO_MODEL_PATH=/home/lukas/catkin_ws/src/

# Add android to path envrionment variable
PATH="$PATH:/opt/android-studio/bin/"
# NOTE run studio.sh as root

# CLEARPATH - remove when not connected to wifi
export ROS_IP=192.168.0.100
export ROS_MASTER_URI=http://192.168.0.20:11311

# export ROS_MASTER_URI=http://192.168.0.2
# export ROS_MASTER_URI=http://cpr-wlp4s0:11311


# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/lukas/Software/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/lukas/Software/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/lukas/Software/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/lukas/Software/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
